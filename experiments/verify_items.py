...
print("PASS: All 4 degradation types present")
...
final_degradation_fig = "reports/figures_final/10_stress_c_degradation_by_type.png"
assert os.path.exists(final_degradation_fig)
print("PASS: final Stress C figure exists")
