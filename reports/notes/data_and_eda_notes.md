...
The preprocessing pipeline replaces `+/-inf` with `NaN` before imputation, so the table reports both raw nulls and infinite values.
| Column | Total Missing After Inf Conversion | Raw NaN | Inf | Missing % | Decision |
|--------|------------------------------------|---------|-----|-----------|----------|
| SRC_TO_DST_SECOND_BYTES | 122,493 | 63,425 | 59,068 | 5.18% | Fill with median (traffic statistic) |
| DST_TO_SRC_SECOND_BYTES | 122,493 | 0 | 122,493 | 5.18% | Fill with median (traffic statistic) |
...
| SRC_TO_DST_SECOND_BYTES | 371.346 | 563.398 | 0.000 | 4412.000 | 1.872 |
| DST_TO_SRC_SECOND_BYTES | 134.999 | 254.896 | 0.001 | 8712.000 | 4.978 |
