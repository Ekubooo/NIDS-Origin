...
results/strategy2_stress_a.csv
```
...
| Stress A unknown-detection AUROC | 0.8446 |
| Stress A unknown vs known disagreement | 0.1850 vs 0.0045 |
...
Under the Stress A open-set setup, disagreement also separates unknown-class
flows from known-class flows:

```text
Unknown-detection AUROC = 0.8446
Unknown mean disagreement = 0.1850
Known mean disagreement = 0.0045
```
