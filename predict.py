...
def main():
    ...
    parser.add_argument("--tau", type=float, default=None,
                        help="Confidence threshold for rejection strategies. "
                             "If omitted, uses artifacts/strategy_config.json when available, else 0.85.")
    ...
    # Use saved tau only when the user did not explicitly pass --tau.
    if args.strategy in ("confidence_threshold", "ensemble+threshold"):
        if args.tau is None and strategy_config and "tau" in strategy_config:
