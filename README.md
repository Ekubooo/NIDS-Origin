...
# Phase 4 (supplementary): Reproducible Stress B feature-shift statistics
python experiments/analyze_stress_b_shift.py

# Final report figures
python experiments/rebuild_final_stress_c_figure.py
python experiments/create_final_supplemental_figures.py
...
- `analyze_stress_b_shift.py` (Stress B source/target feature statistics)
- `rebuild_final_stress_c_figure.py` (final Stress C figure from CSV)
- `create_final_supplemental_figures.py` (supplemental final-report figures)
...
│   ├── analyze_stress_b_shift.py # Stress B feature-shift statistics
│   ├── rebuild_final_stress_c_figure.py
│   ├── create_final_supplemental_figures.py
│   ├── run_strategies.py
│   ├── run_ablation.py
│   └── run_failure_analysis.py
│
...
├── reports/
│   ├── figures/               # Script-generated raw figures (PNG)
│   ├── figures_final/         # Final report figures to use
│   ├── archive/               # Legacy outputs moved out of active result folders
...
| Strategy 2 (M=5) | Stress A unknown-detection AUROC | 0.8446 |
